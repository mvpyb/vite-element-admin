...
<template>
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPaneEl" class="tags-view-wrapper" @scroll="handleScroll" :tagRefList="tagRefList">
<!--      ref="tag"-->
      <router-link
...
<script>
  ...
  import {
    ...
    onMounted,
    onBeforeMount,
    getCurrentInstance, onBeforeUpdate
  } from "vue"
  import { useRouter, useRoute } from "vue-router"
  import { useStore } from "vuex"
  import { isIterable } from '/@/utils/validate'
    ...
    setup() {
      ...
      function moveToCurrentTag() {
        nextTick( () => {
          ...
          // console.log( 'tagRefList', tagRefList )
          // console.log( 'tags', tags )
          // console.log( 'target', tags.target )
          // console.log( 'isIterable', isIterable( tags ) )
          ...
          for (const item of tagRefList) {
            if (item.to.path === route.path) {
              console.log( 'scrollPaneEl', scrollPaneEl.value )
              scrollPaneEl.value && scrollPaneEl.value.moveToTarget( item )
