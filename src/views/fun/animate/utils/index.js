...
const initialEffects = [
  ...
  },
  {
    ...
    category : 'button',
    html : '<svg xmlns="http://www.w3.org/2000/svg" width="5.002" height="8.576" viewBox="0 0 5.002 8.576"><path d="M1.06,8.428a.5.5,0,0,1-.71,0l-.2-.2A.49.49,0,0,1,0,7.868V.708A.49.49,0,0,1,.15.348l.2-.2a.5.5,0,0,1,.71,0l3.79,3.79a.48.48,0,0,1,0,.7Z"/></svg><span>Hover me</span>'
  },
  {
  ...
  },
  {
    ...
    category : 'animation',
    html : '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="20"><path d="M7.5 0a.5.5 0 01.5.5v16.17l4.44-4.45a.5.5 0 01.71 0l.7.71a.5.5 0 010 .71l-6.13 6.14a.75.75 0 01-.53.22h-.38a.77.77 0 01-.53-.22L.15 13.64a.5.5 0 010-.71l.7-.71a.49.49 0 01.7 0L6 16.67V.5a.5.5 0 01.5-.5z"/></svg>'
  },
  {
...
const effects = initialEffects.map( ( effect ) => {
  return {
    ...effect,
    css : styles[effect.className] ? styles[effect.className].value : '--'
  }
} )
