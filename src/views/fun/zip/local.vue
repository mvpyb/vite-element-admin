<template>
  <div v-loading="loading">
    <el-button type="primary" @click="unzipLocal" style="margin-bottom: 30px;">选择文件</el-button>
    <el-alert v-if="error" title="文件解压出错" type="error"> </el-alert>
    <input class="fileInp" type="file" ref="local" accept="application/zip" @change="selectLocal">
    
    <div class="file-info" >
      <el-table :data="fileList" style="width: 100%">
        <el-table-column type="index" width="50"> </el-table-column>
        <el-table-column prop="name" label="文件路径" > </el-table-column>
        <el-table-column prop="dir" label="是否是目录" width="100"> </el-table-column>
