...
style="width: 130px">
          ...
          <el-button v-wave class="filter-item" type="primary" :icon="Search" @click="handleFilter">
            搜索
          </el-button>
          <el-button class="filter-item" style="margin-left: 10px;" type="primary" :icon="EditPen" @click="handleCreate">
            添加
          </el-button>
          <el-button v-wave :loading="downloadLoading" class="filter-item" type="primary" :icon="Download" @click="handleDownload">
            导出
          </el-button>
          <el-checkbox v-model="showReviewer" class="filter-item" style="margin-left:15px;" @change="tableKey.value = tableKey.value + 1">
            审核人
          </el-checkbox>
        </div>
        ...
        <el-dialog :title="set.textMap[dialogStatus]" v-model="dialogFormVisible">
          ...
          >
            ...
            <el-form-item label="Imp">
              <el-rate v-model="set.temp.importance" :colors="['#99A9BF', '#F7BA2A', '#FF9900']" :max="3" style="margin-top:8px;" />
            </el-form-item>
            <el-form-item label="Remark">
              <el-input v-model="set.temp.remark" :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="Please input" />
            </el-form-item>
          </el-form>
